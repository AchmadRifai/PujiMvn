...
--
-- Host: localhost
-- Waktu pembuatan: 19 Bulan Mei 2018 pada 17.04
-- Versi server: 10.2.14-MariaDB
-- Versi PHP: 7.1.17
...
--
-- Dumping data untuk tabel `kat_menu`
--
...
--
ALTER TABLE `bahan`
  ADD KEY `FK_bahan_menu` (`menu`),
  ADD KEY `FK_bahan_persediaan` (`bahan`);

--
-- Indeks untuk tabel `item_pesanan`
--
ALTER TABLE `item_pesanan`
  ADD KEY `FK__pesanan` (`nota`),
  ADD KEY `FK__menu` (`menu`);
...
--
-- Indeks untuk tabel `kat_menu`
--
ALTER TABLE `kat_menu`
  ADD PRIMARY KEY (`kode`);
